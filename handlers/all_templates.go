...
func init() {
	...
	templates := []tmpl{
		...
		{name: verificationPage, fmap: loginFuncMap(), templates: []string{verificationTemplate}},
...
// Functions used by the 'verificationPage' templates
func verificationFuncMap() template.FuncMap {
