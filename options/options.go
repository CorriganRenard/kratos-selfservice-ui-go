...
type Options struct {
	...
	// CSRF Cookie Name is the name of the CSRF cookie used to talk with kratos
...
func (o *Options) SetFromCommandLine() *Options {
	...
	flag.StringVar(&CSRFCookieName, "csrf-cookie-name", "", "Optional the name of the csrf cookie to be forwarded to kratos at login flow")
	...
	o.CSRFCookieName = CSRFCookieName
...
func (o *Options) RegistrationURL() string {
	...
	url.Path = strings.TrimSuffix(url.Path, "/") + "/self-service/registration/browser"
	return url.String()
}
...
func (o *Options) SettingsURL() string {
	url := *o.KratosBrowserURL
	url.Path = strings.TrimSuffix(url.Path, "/") + "/self-service/settings/browser"
	return url.String()
}
...
func (o *Options) LoginFlowURL() string {
	url := *o.KratosBrowserURL
	url.Path = strings.TrimSuffix(url.Path, "/") + "/self-service/login/browser"
	url.Query().Add("state", "blah")

	return url.String()
}

// VerificationFlowURL returns the URL to redirect to that will
// start the Verification flow
func (o *Options) VerificationFlowURL() string {
	url := *o.KratosBrowserURL
	url.Path = strings.TrimSuffix(url.Path, "/") + "/self-service/verification/browser"
...
func (o *Options) RecoveryFlowURL() string {
	url := *o.KratosBrowserURL
	url.Path = strings.TrimSuffix(url.Path, "/") + "/self-service/recovery/browser"
	return url.String()
}
...
func (o *Options) LogoutFlowURL() string {
	url := *o.KratosBrowserURL
	url.Path = strings.TrimSuffix(url.Path, "/") + "/self-service/logout/browser"
	return url.String()
}
